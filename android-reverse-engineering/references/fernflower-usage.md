...
Fernflower is the JetBrains analytical Java decompiler. [Vineflower](https://github.com/Vineflower/vineflower) is the actively maintained community fork with better output quality and published releases — it is the recommended choice.
...
| Both decompilers available | Use both and compare |
